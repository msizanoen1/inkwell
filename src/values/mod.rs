...
use llvm_sys::core::{
    LLVMDumpValue, LLVMGetFirstUse, LLVMGetMetadata, LLVMHasMetadata, LLVMIsAInstruction,
    LLVMIsConstant, LLVMIsNull, LLVMIsUndef, LLVMPrintTypeToString, LLVMPrintValueToString,
    LLVMReplaceAllUsesWith, LLVMSetMetadata, LLVMTypeOf,
};
...
impl Value {
    ...
    fn set_name(&self, name: &str) {
        ...
        )))]
        {
            ...
            unsafe { LLVMSetValueName2(self.value, name.as_ptr() as *const c_char, name.len()) }
        }
    }
